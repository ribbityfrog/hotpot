<template>
    <Page class="gap-y-12">
        ...
        <Section start title="What's this ?">
            ...
            <p class="mt-2">Curious how I did it ? It's open-source : <ULink to="https://github.com/ribbityfrog/hotpot" target="_blank" external>https://github.com/ribbityfrog/hotpot</ULink></p>
        </Section>
